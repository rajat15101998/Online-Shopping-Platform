...
<form name="alogin" method="post" action="welcomeanalyst.jsp">
...
<td></td>
<td>Username:</td>
<td><input type="text" size=18 name="userid" required style="font-size:14pt;"></td>
</tr>
...
if(form.userid.value == "analyst" && form.pwd.value == "1234")
{
